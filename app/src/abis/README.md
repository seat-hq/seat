...
| `StakingPool.json` | `out/StakingPool.sol/StakingPool.json` |
| `ChainlinkOracle.json` | `out/ChainlinkOracle.sol/ChainlinkOracle.json` (optional) |
...
for src, dest in [
    ...
    ("out/StakingPool.sol/StakingPool.json", "StakingPool.json"),
]:
...
Do not fabricate ABIs or addresses. Wire 46630 / 4663 addresses via
`scripts/write-addresses.ts` after a real deploy. Mainnet requires
